...
butler convert --gen2root temp_gen2repo/ --calibs $VALIDATION_DATA_HSC_DIR/CALIB/ validation_hsc_gen3 -C $METRIC_PIPELINE_TASKS_DIR/config/hsc_convert.py
butler register-skymap validation_hsc_gen3/ -C $METRIC_PIPELINE_TASKS_DIR/config/hsc_sky_map.py
